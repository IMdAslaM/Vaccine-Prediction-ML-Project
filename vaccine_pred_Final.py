#try this in Visual Code Studio, it will not work in colab
#import dash
...
def page_home():
    ...
    st.markdown("""## <span style="color:red">Problem Statement of this ML application:</span>""",unsafe_allow_html=True)
...
def page_predict():
    #creating 2 columns in streamlit page for getting input from user
    st.markdown("""# <span style="color:aqua">Predict Vaccine Status</span>""",unsafe_allow_html=True)
    ...
    if st.button('Predict H1N1 Vaccine Status'):#button
                ...
                placeholder.write('Predicting H1N1 Vaccine Status...')
                time.sleep(10)
